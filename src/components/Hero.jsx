            ...
            <div className="px-[8.7rem] grid grid-cols-2 gap-28 items-center py-[4.2rem]">
                <div>
                    ...
                    <div className="flex gap-6">
                        <button className="flex hover:bg-gray-100 py-2.5 items-center px-5 border rounded-lg text-sm font-medium">
                        ...
                        <button className="flex py-2.5 hover:bg-gray-100 items-center px-5 border rounded-lg text-sm font-medium">
                            Get Figma file
                        </button>
                    </div>
                </div>
